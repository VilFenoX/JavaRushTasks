...
public class Solution {
    ...
    public static void main(String... args) throws IOException {
        try (
                FileOutputStream outputStream = new FileOutputStream("F:/Hobbi/Java/JavaRush/output.txt");
                InputStream is = Solution.class.getClassLoader().getResourceAsStream("F:/Hobbi/Java/JavaRush/input.txt");
        ) {
            ;
